...
export const getTemplateDir = (template: TemplateType) => {
  return path.join(__dirname, template);
};

export const getPluginTemplateFile = (plugin: string) => {
  return path.join(__dirname, "plugins", `${plugin}.ts`);
};

export const appBaseTemplate: Template = {
  dir: "app-base",
  main: "server.ts",
  author: "",
...
export const appDrizzleTemplate: Template = {
  dir: "app-drizzle",
  main: "server.ts",
  author: "",
  description: "My awesome project",
